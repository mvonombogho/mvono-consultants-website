  ...
  return (
    <>
      <MetaTags
        ...
        description="Contact Mvono Consultants for professional safety, energy, and plant management services in Kenya and East Africa. Call +254 720 270 694 or email sales@mvonoconsultants.com for expert consultation."
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">+254 720 270 694</p>
                    </div>
                  </div>
