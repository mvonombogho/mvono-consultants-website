            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center lg:justify-start space-y-4 md:space-y-0 md:space-x-4">
                ...
                <a 
                  ...
                  className="inline-flex h-12 min-w-[180px] items-center justify-center rounded-md bg-green-600 hover:bg-green-700 text-white px-6 font-medium shadow transition-colors"
                >
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <a 
                  href="/Mvono Consultants Profile.pdf"
                  download="Mvono_Consultants_Company_Profile.pdf"
                  className="inline-flex h-12 items-center justify-center rounded-md bg-green-600 hover:bg-green-700 text-white px-6 font-medium shadow transition-colors"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3M3 17V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2z" />
                  </svg>
