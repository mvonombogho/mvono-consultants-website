...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${post.title} | Safety & Energy Insights | Mvono Consultants`,
    description: post.excerpt || `Read about ${post.title} from Mvono Consultants' team of safety and energy management specialists`,
    openGraph: {
      images: post.coverImage ? [urlFor(post.coverImage).url()] : [],
      title: `${post.title} | Mvono Consultants`,
      description: post.excerpt || `Professional insights on ${post.title}`,
      type: 'article',
      publishedTime: post.publishedAt,
      authors: post.author?.name ? [post.author.name] : ['Mvono Consultants'],
    },
  };
}
