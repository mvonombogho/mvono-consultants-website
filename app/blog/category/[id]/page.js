import { getPostsByCategory, getAllCategories, getCategoryById } from '../../../lib/api-fixed';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              {category.description || `Expert insights and professional guidance on ${category.title.toLowerCase()}.`}
            </p>
