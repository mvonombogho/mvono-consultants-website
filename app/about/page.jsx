          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {teamMembers.map((member, index) => (
              <div 
                ...
                className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border border-slate-100"
              >
                <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mb-6 mx-auto">
                  {member.icon}
                </div>
                <h3 className="text-xl font-bold mb-1 text-center text-slate-900">{member.name}</h3>
                <p className="text-blue-600 font-medium mb-4 text-center">{member.position}</p>
                <p className="text-slate-600 mb-4">{member.bio}</p>
                
                <h4 className="text-sm font-semibold uppercase tracking-wider text-slate-500 mb-3">Areas of Expertise</h4>
                <ul className="space-y-2">
