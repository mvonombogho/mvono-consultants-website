            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">{client.contactPerson || '-'}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-900">{client.kraPin || '-'}</p>
                </div>
              ...
              {client._count?.projects > 0 ? (
                <div className="text-center py-8">
                  ...
                  <Link
                    ...
                    className="text-primary-600 hover:text-primary-800 font-medium transition-colors mt-2 inline-block"
                  >
                    View All Projects
                  </Link>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
            ...
            <div className="p-6">
              <div className="space-y-3">
                ...
                >
                  <FaTrash className="text-red-600 mr-3" />
