...
const ClientLogo: React.FC<ClientLogoProps> = ({ client, isVisible = true }) => {
  return (
...
const ClientsSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (marquee) {
      ...
      const totalWidth = Array.from(logos).reduce((acc, logo) => acc + (logo as HTMLElement).offsetWidth + 32, 0) // 32px for margins
