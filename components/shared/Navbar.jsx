      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a 
            ...
            className="inline-flex items-center text-sm font-medium bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-md transition-colors"
          >
        ...
        <div className="md:hidden bg-white shadow-lg absolute w-full left-0 py-4 px-4">
          <nav className="flex flex-col space-y-4">
            ...
            <a 
              href="/Mvono Consultants Profile.pdf"
              download="Mvono_Consultants_Company_Profile.pdf"
              className="inline-flex items-center text-base font-medium bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md transition-colors w-fit"
              onClick={() => setMobileMenuOpen(false)}
            >
