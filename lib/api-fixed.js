// Direct Sanity client setup to avoid import issues
import { createClient } from 'next-sanity';
import groq from 'groq';

// Create client directly here to avoid circular imports
const client = createClient({
  projectId: process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || 'k6xvho7h',
  dataset: process.env.NEXT_PUBLIC_SANITY_DATASET || 'production',
  apiVersion: process.env.NEXT_PUBLIC_SANITY_API_VERSION || '2025-05-19',
